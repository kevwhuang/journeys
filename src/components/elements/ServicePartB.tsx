...
function ServicePartB(): React.ReactElement {
    return (
        <section className="service__part-b">
            <h5 id="chapter-1">1. OUR SERVICES</h5>
            ...
            <h5 id="chapter-2">2. INTELLECTUAL PROPERTY RIGHTS</h5>
            ...
            <p>Subject to your compliance with these Legal Terms, including the "<a href="#chapter-5">PROHIBITED ACTIVITIES</a>" section below, we grant you a non-exclusive, non-transferable, revocable license to:</p>
            <ul>
                <li>
            ...
            <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: kevin@aephonics.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
            <p>We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.</p>
            <p>Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms and your right to use our Services will terminate immediately.</p>
            <h6>Your submissions and contributions</h6>
            <p>Please review this section and the "<a href="#chapter-5">PROHIBITED ACTIVITIES</a>" section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.</p>
            ...
            <ul>
                <li>
                    <p>confirm that you have read and agree with our "<a href="#chapter-5">PROHIBITED ACTIVITIES</a>" and will not post, send, publish, upload, or transmit through the Services any Submission nor post any Contribution that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to any person or group, sexually explicit, false, inaccurate, deceitful, or misleading;</p>
                </li>
                <li>
            ...
            <p>We respect the intellectual property rights of others. If you believe that any material available on or through the Services infringes upon any copyright you own or control, please immediately refer to the "<a href="##chapter-13">COPYRIGHT INFRINGEMENTS</a>" section below.</p>
            <h5 id="chapter-3">3. USER REPRESENTATIONS</h5>
            ...
            <h5 id="chapter-4">4. USER REGISTRATION</h5>
            ...
            <h5 id="chapter-5">5. PROHIBITED ACTIVITIES</h5>
            ...
            <h5 id="chapter-6">6. USER GENERATED CONTRIBUTIONS</h5>
            ...
            <h5 id="chapter-7">7. CONTRIBUTION LICENSE</h5>
            ...
            <h5 id="chapter-8">8. MOBILE APPLICATION LICENSE</h5>
            <h6>Use License</h6>
            ...
            <h5 id="chapter-9">9. SOCIAL MEDIA</h5>
            ...
            <h5 id="chapter-10">10. THIRD-PARTY WEBSITES AND CONTENT</h5>
