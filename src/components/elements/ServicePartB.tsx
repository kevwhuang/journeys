...
function ServicePartB(): React.ReactElement {
    return (
        <section className="service__part-b">
            <h5 id="article1">1. OUR SERVICES</h5>
            ...
            <h5 id="article2">2. INTELLECTUAL PROPERTY RIGHTS</h5>
            ...
            <h5 id="article3">3. USER REPRESENTATIONS</h5>
            ...
            <h5 id="article4">4. USER REGISTRATION</h5>
            ...
            <h5 id="article5">5. PROHIBITED ACTIVITIES</h5>
            ...
            <h5 id="article6">6. USER GENERATED CONTRIBUTIONS</h5>
            ...
            <h5 id="article7">7. CONTRIBUTION LICENSE</h5>
            ...
            <h5 id="article8">8. MOBILE APPLICATION LICENSE</h5>
            <h6>Use License</h6>
            ...
            <h5 id="article9">9. SOCIAL MEDIA</h5>
            ...
            <h5 id="article10">10. THIRD-PARTY WEBSITES AND CONTENT</h5>
